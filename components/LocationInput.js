  ...
  render() {
    return (
      ...
      >
        ...
        <div className="quit-location" onClick={this.props.disableGeoInput}>
        </div>
        <div className="send-location" onClick={this.locationMessageInput.bind(this)}>
        </div>
        <div className="pin-location" style={{display: this.state.opacity ? "block" : "none"}}>
        </div>
      </div>
    );
  }
